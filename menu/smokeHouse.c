...
const struct MenuOption SMOKE_HOUSE_MENU[] = {
    { TXT_IDX_MENU_SMOKEHOUSE1, '1', SCREEN_SPLIT_MC_TXT, UI_SELECT, &_shMenu1, 0, 1, 1},
    { TXT_IDX_MENU_SMOKEHOUSE2, '2', SCREEN_SPLIT_MC_TXT, UI_SELECT, &_shMenu2, 0, 1, 2},
    { TXT_IDX_MENU_SMOKEHOUSE3, '3', SCREEN_SPLIT_MC_TXT, UI_SELECT, &_shMenu3, 0, 1, 3},

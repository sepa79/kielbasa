...
const struct MenuOption VILLIAGE_MAP_MENU[] = {
    { TXT_MENU_W, 'w', SCREEN_HIRES_TXT, UI_U+UI_HIDE, &_mapUp, 0, 1, 1},
    { TXT_MENU_S, 's', SCREEN_HIRES_TXT, UI_D+UI_HIDE, &_mapDown, 0, 1, 1},
    { TXT_MENU_A, 'a', SCREEN_HIRES_TXT, UI_L+UI_HIDE, &_mapLeft, 0, 1, 1},
    { TXT_MENU_D, 'd', SCREEN_HIRES_TXT, UI_R+UI_HIDE, &_mapRight, 0, 1, 1},
    // { TXT_IDX_MENU_TASK_MANAGER_D, KEY_RETURN, SCREEN_HIRES_TXT, UI_F+UI_HIDE, &_mapFire, 0, 1, 1},
    { TXT_MENU_EXIT, KEY_ARROW_LEFT, SCREEN_HIRES_TXT, UI_F+UI_HIDE, &gotoLocation, 0, 2, 5},
    END_MENU_CHOICES
};

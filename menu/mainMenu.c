...
const struct MenuOption MAIN_MENU[] = {
    {TXT_IDX_MENU_MAIN1, '1', UI_SELECT, &showMenu, MENU_BANK_FARMLAND, 1, 1},
    {TXT_IDX_MENU_MAIN2, '2', UI_SELECT, &showMenu, MENU_BANK_PIG_PEN, 1, 2},
    {TXT_IDX_MENU_MAIN3, '3', UI_SELECT, &showMenu, MENU_BANK_SMOKE_HOUSE, 1, 3},
    {TXT_IDX_MENU_MAIN4, '4', UI_SELECT, &showMenu, MENU_BANK_SHOP, 1, 4},
    {TXT_IDX_MENU_MAIN5, '5', UI_SELECT, &showMenu, MENU_BANK_CREW, 1, 5},
    {TXT_IDX_MENU_MAIN6, '6', UI_SELECT, &showMenu, MENU_BANK_PIGSLE_COMMAND_1, 1, 6},
    {TXT_IDX_MENU_MAIN7, '7', UI_LF+UI_SELECT, &showMenu, MENU_BANK_MAP_VILLIAGE_1, 1, 8},
    END_MENU_CHOICES
};

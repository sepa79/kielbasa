...
__export const byte mainMenuGfx1[] = {
    #embed 0x0f00 0x0002 "assets/multicolorGfx/Main_Last2.prg"
    #embed 0x01e0 0x1f42 "assets/multicolorGfx/Main_Last2.prg"
    #embed 0x01e0 0x232a "assets/multicolorGfx/Main_Last2.prg"
};

...
const struct MenuOption MAIN_MENU[] = {
    ...
    {TXT_IDX_DEBUG_1, '4', SCREEN_TRANSITION, UI_SELECT, &showMenu, MENU_BANK_FISHING_MENU, 1, 7 },
    ...
    {TXT_IDX_DEBUG_4, '7', SCREEN_TRANSITION, UI_SELECT, &showMenu, MENU_BANK_PIGSLE_MENU, 1, 10 },

...
const struct MenuOption MAIN_MENU[] = {
    ...
    {TXT_IDX_MENU_AIR_DEF, '4', SCREEN_TRANSITION, UI_SELECT, &showMenu, MENU_BANK_FISHING_MENU, 1, 7 },
    {TXT_IDX_MENU_AIR_DEF, '5', SCREEN_TRANSITION, UI_SELECT, &showMenu, MENU_BANK_RESPAWN, 1, 8 },
    {TXT_IDX_MENU_AIR_DEF, '6', SCREEN_TRANSITION, UI_SELECT, &showMenu, MENU_BANK_BATTLE_MENU, 1, 9 },
    {TXT_IDX_MENU_AIR_DEF, '7', SCREEN_TRANSITION, UI_SELECT, &showMenu, MENU_BANK_PIGSLE_COMMAND_1, 1, 10 },

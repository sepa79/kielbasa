...
const struct MenuOption SHOP_INSIDE_MENU[] = {
    { TXT_IDX_MENU_SHOPIN1, '1', UI_SELECT, &_siMenu1, 0, 1, 1},
    { TXT_IDX_MENU_SHOPIN2, '2', UI_SELECT, &_siMenu2, 0, 1, 2},
    { TXT_IDX_MENU_EXIT, KEY_ARROW_LEFT, UI_SELECT, &_goBackToPrvMenu, 0, 2, 3},
    END_MENU_CHOICES
};

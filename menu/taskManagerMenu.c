...
const struct MenuOption TASK_MANAGER_MENU[] = {
    ...
    { TXT_IDX_MENU_W, 'w', SCREEN_FULL_TXT, UI_U+UI_HIDE, &_upRow, 0, 0, ROW_OFFSET_TASKLIST_TM-1 },
    { TXT_IDX_MENU_S, 's', SCREEN_FULL_TXT, UI_D+UI_HIDE, &_downRow, 0, 0, ROW_OFFSET_TASKLIST_TM+10 },

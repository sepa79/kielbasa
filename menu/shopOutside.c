...
const struct MenuOption SHOP_OUTSIDE_MENU[] = {
    { TXT_IDX_MENU_SHOPOUT1, '1', UI_UD, &_getInside, 0, 1, 4},
    { TXT_IDX_MENU_SHOPOUT2, '2', UI_UD, &_soMenu2, 0, 1, 5},
    { TXT_IDX_MENU_EXIT, KEY_ARROW_LEFT, UI_UD, &showMenu, MENU_BANK_MAIN_MENU, 2, 7},
    END_MENU_CHOICES
};

...
// Main texts
// =============================================================================
const char TXT_EN_MENU_CANCEL[] = s"\x1fCancel";
const char TXT_EN_MENU_EXIT[] = s"\x1fBack";
// fixed width - 28
const char TXT_EN_TASK_LIST_HEADER[] = underline(s"  Task  ") "\x7f" underline(s"    Description    ");

const char TXT_EN_MENU_MAIN1[] = s"\xb1Farmland";
const char TXT_EN_MENU_MAIN2[] = s"\xb2Pigpen";
const char TXT_EN_MENU_MAIN3[] = s"\xb3Smokehouse";
const char TXT_EN_MENU_MAIN4[] = s"\xb4Shop";
const char TXT_EN_MENU_MAIN5[] = s"\xb5Crew";

// =============================================================================
// Options
// =============================================================================
const char TXT_EN_MENU_OPTIONS_LANG[] = s"\xb1Language / J\x5dzyk";
const char TXT_EN_MENU_OPTIONS_MSX[] = s"\xb2Music on/off";
...
// =============================================================================
// 4 options in Common
const char TXT_EN_MENU_FARMLAND5[] = s"\xb1Grow";
const char TXT_EN_MENU_FARMLAND6[] = s"\xb2Care";
const char TXT_EN_MENU_FARMLAND7[] = s"\xb3Reap";
// fixed width 
...
// Pig pen
// =============================================================================
const char TXT_EN_MENU_PIGPEN1[] = s"\xb1Feed";
const char TXT_EN_MENU_PIGPEN2[] = s"\xb2Cleanup";
const char TXT_EN_MENU_PIGPEN3[] = s"\xb3Upgrade";

const char TXT_EN_MENU_SMOKEHOUSE1[] = s"\xb1Recipies";
const char TXT_EN_MENU_SMOKEHOUSE2[] = s"\xb2Cleanup";
const char TXT_EN_MENU_SMOKEHOUSE3[] = s"\xb3Upgrade";

const char TXT_EN_MENU_SHOPOUT1[] = s"\xb1Go in";
const char TXT_EN_MENU_SHOPOUT2[] = s"\xb2Chat";
const char TXT_EN_SHOP_DESCRIPTION[] = s"A general store, open 7-11, then 15-19, everyday";

const char TXT_EN_MENU_SHOPIN1[] = s"\xb1Buy gherkin";
const char TXT_EN_MENU_SHOPIN2[] = s"\xb2Chat";

const char TXT_EN_MENU_CREW1[] = s"\xb1Char 1";
const char TXT_EN_MENU_CREW2[] = s"\xb2Char 2";
const char TXT_EN_MENU_CREW3[] = s"\xb3Char 3";
const char TXT_EN_MENU_CREW4[] = s"\xb4Char 4";
...
// names are in Common
const char TXT_EN_CHAR_1_STORY[] = s"Janusz spent his whole life working in PGR. He does not really excel in anything,\nbut thankfully he is lazy\nand an addict. He is your\nmain character.";
const char TXT_EN_CHAR_2_STORY[] = s"Zdzisiek is not very popularin the villiage. Folks reme-mber that his father was a\nvolksdeustch. He is bright -like his father - and that\nmakes him stand out.";
const char TXT_EN_CHAR_3_STORY[] = s"Wiesiek's story will be here.";
const char TXT_EN_CHAR_4_STORY[] = s"J\x60zek's story will be here.";

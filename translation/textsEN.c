...
//
//
// This file is autogenerated by 'create_translations.py' script.
//
//
...
//     "en": "['    Hello! +/-/Space - time control    Kielbasa Empire - very early alpha. ', '    Credits: ', '    Code support and compiler: Oscar64 - DrMortalWombat ', '    Game: Code - Sepa, Koval, Gfx - Juras, Model3 & Saturnz, Msx - Crisps, Support - Angry Andy, Fonts - Sepa ', '    Special thanks for KickC support: KickC - Rex/Camelot,']"

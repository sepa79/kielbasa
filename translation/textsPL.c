...
//     "pl": "['    Witaj! +/-/Space - kontrola czasu    Kielbasa Empire - wersja bardzo alpha. ', '    Credits: ', '    Wsparcie programistyczne i kompilator: Oscar64 - DrMortalWombat ', '    Gra: Kod - Sepa, Koval, Gfx - Juras, Model3 & Saturnz, Msx - Crisps, Support - Angry Andy, Fonts - Sepa ', '    Specialne podziękowania dla Rex/Camelot za pomoc przy KickC ']"

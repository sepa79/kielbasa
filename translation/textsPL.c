...
// "Sklep wielobranżowy 'GS', otwarty 7-11 i 15-19, codziennie."
...
// "Janusz całe życie pracował w PGR. Na niczym się tak naprawdę nie zna, ale za to ma  nałogi i jest leniwy. Janusz to postać startowa."
...
// "Zdzisiek nie jest popularny we wsi. Ludziska pamiętają, że jego ojciec był folks-dojczem. Zdzisia wyróżnia inteligencja po tacie."
...
// "['    Witaj! +/-/Space - kontrola czasu    Kielbasa Empire - wersja bardzo alpha. ', '    Credits: ', '    Wsparcie programistyczne i kompilator: Oscar64 - DrMortalWombat ', '    Gra: Kod - Sepa, Koval, Gfx - Juras, Model3 & Saturnz, Msx - Crisps, Support - Angry Andy, Fonts - Sepa ', '    Specialne podziękowania dla Rex/Camelot za pomoc przy KickC ']"

...
enum TEXT_INDEXES {
    ...
    TXT_IDX_TASK_MANAGER_TABLE_HEADER_4,
    TXT_IDX_TASK_MANAGER_TABLE_HEADER_5,
    TXT_IDX_TASK_MANAGER_TABLE_HEADER_6,
    TXT_IDX_TASK_MANAGER_TABLE_HEADER_7,
    TXT_IDX_TASK_MANAGER_TABLE_HEADER_8,
    TXT_IDX_TASK_MANAGER_TABLE_HEADER_9,
    TXT_IDX_TASK_MANAGER_TABLE_HEADER_10,

...
const char TXT_PL_PLANT_STAGE_SOW_TASK_ASSIGNED[] =  s"Z: Siew ";
...
const char TXT_PL_PLANT_STAGE_REAP_TASK_ASSIGNED[] =  s"Z: Zbi\y60r";
...
const char TXT_PL_MENU_OPTIONS_LANG[] =  s"\yb1J\y5dzyk / Language";
const char TXT_PL_MENU_OPTIONS_MSX[] =  s"\yb2Muzyka on/off";
...
const char TXT_PL_TASK_MANAGER_PRIO_TABLE_HEADER_1[] =  s"                     \y7f\yda\y84\y8f\y8c\y8e\y8f\ye1\ydc\y7f\ya0\yda\y81\y84\y81\y8e\y89\y85";
...
const char TXT_PL_MENU_TASK_MANAGER_PLUS[] =  s"+";
...
const char TXT_PL_FARM_FIELD_TXT[] =  s"Pole:  ";
const char TXT_PL_FARM_PLANT_TXT[] =  s"Uprawa: ";
...
const char TXT_PL_SHOP_DESCRIPTION[] =  s"Sklep wielobran\y63oy 'GS', otwarty 7-11 i 15-19, codziennie.";
...
const char TXT_PL_CHAR_1_STORY[] =  s"Janusz ca\y5ee \y63ycie pracowa\y5e w PGR. Na niczym si\y5d tak naprawd\y5d nie zna, ale za to ma na\y5eogi i jest leniwy. Janusz to posta\y5c startowa.";
const char TXT_PL_CHAR_2_STORY[] =  s"Zdzisiek nie jest popularny we wsi. Ludziska pami\y5dtaj\y5b, \y63e jego ojciec by\y5e folks-dojczem. Zdzisia wyr\y60\y63nia inteligencja po tacie.";
...
const char SB_PL_WELCOME[] =  s"    Witaj! +/-/Space - kontrola czasu    Kielbasa Empire - wersja bardzo alpha.    Credits:        Wsparcie programistyczne i kompilatory: KickC - Rex/Camelot, Oscar64 - DrMortalWombat        Gra: Kod - Sepa, Gfx - Juras, Model3 & Saturnz, Msx - Taurus, Support - Angry Andy, Fonts - Sepa    ";

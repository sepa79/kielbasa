...
const char TXT_EN_PLANT_NAME_POTATO[] =  s"";
const char TXT_EN_PLANT_NAME_LUPINE[] =  s"";
const char TXT_EN_PLANT_NAME_WHEAT[] =  s"";
const char TXT_EN_PLANT_NAME_CORN[] =  s"";
...
const char TXT_EN_MENU_TASK_MANAGER_W[] =  s"";
const char TXT_EN_MENU_TASK_MANAGER_S[] =  s"";
const char TXT_EN_MENU_TASK_MANAGER_A[] =  s"";
const char TXT_EN_MENU_TASK_MANAGER_D[] =  s"";
...
const char SB_EN_WELCOME[] =  s"    Hello! +/-/Space - time control    Kielbasa Empire - very early alpha.    Credits:        Code support and compilers: KickC - Rex/Camelot    Oscar64 - DrMortalWombat    Game: Code - Sepa, Gfx - Juras, Model3 & Saturnz, Msx - Taurus, Support - Angry Andy, Fonts - Sepa ";

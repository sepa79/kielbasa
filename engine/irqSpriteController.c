...
__interrupt void showMapSpritesBottom(){
    ...
    UI_SCR[OFFSET_SPRITE_PTRS+0] = SPR_BANK_CHARACTER_PORTRAIT1;
    UI_SCR[OFFSET_SPRITE_PTRS+1] = SPR_BANK_CHARACTER_BAR1;
    UI_SCR[OFFSET_SPRITE_PTRS+2] = SPR_BANK_TXT_BOTTOM_1;
    UI_SCR[OFFSET_SPRITE_PTRS+3] = SPR_BANK_TXT_BOTTOM_2;
    UI_SCR[OFFSET_SPRITE_PTRS+4] = SPR_BANK_TXT_BOTTOM_3;
    UI_SCR[OFFSET_SPRITE_PTRS+5] = SPR_BANK_TXT_BOTTOM_4;
    UI_SCR[OFFSET_SPRITE_PTRS+6] = SPR_BANK_CHARACTER_PORTRAIT4;
    UI_SCR[OFFSET_SPRITE_PTRS+7] = SPR_BANK_CHARACTER_BAR4;
